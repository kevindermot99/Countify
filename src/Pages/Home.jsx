...
function Home() {
    return (
        <div className="w-full h-svh flex flex-col items-start justify-start relative text-black">
            {/* hero */}
            <div className="flex items-center justify-start flex-col bg-black text-white relative w-full h-fit">
                ...
                {/* visuals */}
                <div className='w-full flex-1 flex items-start justify-between overflow-clip gap-10 pt-5 px-10 max-md:px-4 mt-5 z-20 max-w-[1500px] max-h-[550px] '>
